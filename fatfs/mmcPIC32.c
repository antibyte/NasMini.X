...
#define CS_SETOUT() TRISAbits.TRISA0 = 0
#define CS_LOW()  LATACLR = _LATA_LATA0_MASK	/* MMC CS = L */
#define CS_HIGH() LATASET = _LATA_LATA0_MASK	/* MMC CS = H */
...
)
{
	BYTE n, cmd, ty, ocr[4];
        ...
        // for pic32mx1/2
        RPB1R=0x03;  // PPS MAP SDO1 to RPB1
        SDI1R=0x00;  // PPS MAP SDI1 to RPA1
